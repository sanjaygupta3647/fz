...
<header>
      ...
      <div class="hrd-right-wrap">
        ...
        <div class="brdcm" id="hed-tit">Announcement Management</div>
         <?php if($_GET[mode]){?>
       <div class="unvrl-btn">  <a href="javascript:void(0)" onclick="javascript:formback();" class="ub">
        <img src="<?=SITE_PATH_MEM?>images/back.png" alt=""></a></div><?php }?> 
      </div>
      <div class="cl"></div>
