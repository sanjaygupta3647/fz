...
<?php $hedtitle = "Category Management"; ?> 
      ...
      <div class="tbl-contant">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"  class="data-tbl">
          <tr class="t-hdr">
            ...
            <td width="37%" align="center"><?=$adm->orders('Category Name',true)?></td>
            <td width="27%" align="center"><?=$adm->orders('Sub Category',true)?></td>
          ...
          <tr <?=$adm->even_odd($nums)?>>
			...
			$tot =$cms->db_query("select pid from #_category where parentId='$pid'");
			 ...
			 if($cnt){?> <a href="<?=SITE_PATH_ADM.CPAGE."/manage-category.php?parentId=".$pid?>">View(<?=$cnt?>)</a> <?php } else echo "--"; 
