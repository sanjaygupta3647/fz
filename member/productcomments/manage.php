...
<?php 
	...
	if($action=='del'){
 		$cms->db_query("delete from #_review where pid in ($id)");
	...
	$columns = "select * ";
	$sql = " from #_review where type='product' and 1 $cond ";
...
?>
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"  class="data-tbl">
    <tr class="t-hdr">
	  ...
	  <td width="20%" align="center"><?=$adm->orders('Product Title',true)?></td> 
      <td width="20%" align="center"><?=$adm->orders('Comment Title',true)?></td> 
 	  <td width="15%" align="center"><?=$adm->orders('Comment',true)?></td>
	   <td width="10%" align="center"><?=$adm->orders('Star',true)?></td>
	   <td width="10%" align="center"><?=$adm->orders('Staus',true)?></td>
    ...
    <td align="center"><?=$adm->check_input($pid)?></td>
	 <td align="center"><?=ucfirst($cms->getSingleresult("select title from #_products_user where pid='".$prod_id."' "));?></td> 
