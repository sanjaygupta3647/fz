...
<?php 
	...
	$columns = "select * ";
	$sql = " from #_pages where store_user_id = '".$_SESSION[uid]."' and ".(($subpageid)?" `subpageid` = '".$subpageid."' ":" `subpageid` = '0' ");
...
<div class="internal-data">
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"  class="data-tbl">
    <tr class="t-hdr">
	  ...
	  <td width="20%" align="center"><?=$adm->orders('Link',true)?></td>
	...
	<td align="center" class="<?=strtolower($status)?>"><input type="text" size="50" value="<?=SITE_PATH.'page/'.$url?>" /></td>
