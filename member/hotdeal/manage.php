...
<?php 
	...
	$columns = "select * ";
	$sql = " from #_offer where offertype = 'hotdeal'  and store_user_id = '".$_SESSION[uid]."' ";
...
?>
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"  class="data-tbl">
    <tr class="t-hdr">
      ...
      <td width="25%" align="center"><?=$adm->orders('Plan Type',true)?></td>  
	...
	<?=$cms->getSingleresult("select name from #_store_menu where store_user_id ='".$_SESSION[uid]."' and cat_id='$cat_id' ");?></td> 
    <td align="center"><?php
	if($type=='qty') echo "Quantity Wise"; else echo"Flat Off";
	?></td> 
