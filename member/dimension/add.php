...
if(isset($id)){
	$rsAdmin=$cms->db_query("select * from #_dimension where pid='".$id."' and store_user_id = '".$_SESSION[uid]."' ");
...
?>
  ...
  <table width="100%" border="0" align="left" cellpadding="4" cellspacing="1" class="frm-tbl2">
    <tr  class="grey_">
      ...
      <td width="75%"><input name="d_name" type="text" class="txt medium" id="Dimension" lang="R" title="Dimension" value="<?=$d_name?>" /></td>
    </tr>
