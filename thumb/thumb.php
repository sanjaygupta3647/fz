...
// MUST end with slash.
$images_folder=explode("/",$_REQUEST['src']);
...
$tfile=$_REQUEST['src'];
$tfile=str_replace("../","",$_REQUEST['src']);
$fpath=realpath("./../../" . $tfile);
//if (file_exists($fpath))echo("y");
//die("<img src='" . $tfile . "'>");
$tarr=explode("/",$tfile);
$from_name=$tarr[count($tarr)-1];
// generate thumbnail
$img->GenerateThumbFile($fpath, $thumbs_folder . $to_name);
