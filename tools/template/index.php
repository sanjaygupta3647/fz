...
<?php $adm->pageAuth("Manage Mail Template",$perm);?>
<div class="main">
    ...
    <?=$adm->alert()?>
      <div class="title"  id="innertit">
		...
		if($mode=='add' && $id!=''){?>
			...
			<a href="/tools/template" rel="v:url" property="v:title">Template </a> » 
			<a href="/tools/template/?mode=add&amp;start=&amp;id=<?=$id?>" rel="v:url" property="v:title">Edit</a>  
		<?php		
		}else if($mode=='add' && $id=='') { 
		    ?>
			<a href="/tools" rel="v:url" property="v:title">Home</a> »
			<a href="/tools/template" rel="v:url" property="v:title">Template </a> » 
			<a href="/tools/template/?mode=add" rel="v:url" property="v:title">Add</a>  
		<?php
		}else{?>
		    <a href="/tools" rel="v:url" property="v:title">Home</a> »
			<a href="/tools/template" rel="v:url" property="v:title">Template </a> »  
