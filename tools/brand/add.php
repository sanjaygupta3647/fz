  ...
  <table width="100%" border="0" align="left" cellpadding="4" cellspacing="1" class="frm-tbl2">
   ...
   <tr>
	 ...
	 <tr>
      ...
      <td width="75%"><input type="checkbox" name="ispopular"  <?php if($ispopular) echo 'checked'; ?> class="txt medium" value="1" /></td>
    </tr>
	 <?php if($image  and is_file($_SERVER['DOCUMENT_ROOT'].SITE_SUB_PATH."uploaded_files/orginal/".$image)==true){?>
       ...
       <img onClick="window.open('<?=SITE_PATH_MEM."crop/imageupload.php?imgid=upimg&image=brand&view=thumb&name=".$image?>','mywindow','width=900,height=400,left=200,scrollbars=yes, top=100,screenX=0,screenY=100')" src="<?=SITE_PATH_MEM?>images/clickhere.png" alt=""  class="img-click" /> <br /></td>
          </tr> 
	<tr>
	  <td valign="top" class="label">&nbsp;</td>
	  <td valign="top">&nbsp;</td>
