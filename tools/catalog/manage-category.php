...
<?php $adm->pageAuth("Category",$perm);?>
<div class="main">
<header>
    ...
    <h1><? if($parentId) {echo $cms->getSingleresult("select name from #_category where pid='$parentId'");}?></h1>
      ...
      <div class="title"  id="innertit">
		...
		if($mode=='add' && $id!=''){?>
			...
			<a href="/tools/catalog" rel="v:url" property="v:title">Manage Category </a> » 
      ...
      <div class="tbl-contant">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"  class="data-tbl">
          ...
          <tr <?=$adm->even_odd($nums)?>>
            ...
            <td align="center">
			<?=$adm->cataction(SITE_PATH_ADM.CPAGE."/add-category.php",$pid, CPAGE.'/manage-category.php',$start)?>
            </td>
          </tr>
