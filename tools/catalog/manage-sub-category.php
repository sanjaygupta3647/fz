...
<header>
      ...
      <div class="hrd-right-wrap">
        ...
        <div class="unvrl-btn"> 
        <a href="<?=SITE_PATH_ADM.CPAGE.'/add-sub-category.php?parentId='.$parentId?>" class="ub">
...
<?php 
	...
	if($action=='del'){
		...
		$cms->redir(SITE_PATH_ADM.CPAGE."/manage-sub-category.php?parentId=".$parentId, true);
		exit;
	}
	if($cms->is_post_back()){
		if($arr_ids) {
...
<?php $hedtitle = ucfirst(strtolower(stripslashes($cms->getSingleresult("select name from #_category where pid='$parentId'"))))." Product Category"; ?> 
