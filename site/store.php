...
// for store
if($items[6]>0){$cond .= " and cat_id = '".$items[6]."'";}
// for market
//if($items[4]>0){$cond .= " and city_id = '".$items[4]."'";}
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="center" valign="top">
			<?php 
			$search = "select pid,cat_id, title,image from #_store_detail where 1 ".$cond; 
			...
			?>
			 <div class="store_logo"><a href="<?=SITE_PATH?>store/<?=$adm->baseurl($catname)?>/<?php echo $re_visited['pid'];?>"><img src="<?=$img?>" height="60" width="60" /></a></div>
			<?php
			}
			}
			else
