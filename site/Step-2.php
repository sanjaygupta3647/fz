...
<div class="contentarea">
  ...
  <div class="registerarea">
    <div class="heading">Plan Choosen By You :
      ...
      <div class="subarea">
        ...
        <div class="registerbox">
          ...
          <div class="formarea">
            ...
            <label>Address</label>
            <textarea name="address" lang="R" title="Address" id="address" placeholder="Address"><?=$_POST[address]?>
</textarea>
          ...
          <div class="formarea">
            ...
            <textarea name="description" id="textarea" placeholder="Description"><?=$_POST[description]?>
</textarea>
            <label>City</label>
            <?php   
								  $sql_city1="select pid,city from #_city where country_id='80'";
            ...
            <label>Address</label>
            <textarea name="address2" id="textarea"  placeholder="Address"><?=$_POST[address2]?>
</textarea>
            <label>Pin Code</label>
            <input type="text" value="<?=$_POST[pincode2]?>" lang="RisNaN" title="Store Pin Code" name="pincode2"    placeholder="Pin Code"/>
          </div>
          <input type="checkbox" name="vaucher" value="1"  <?=($regMode=='coupon')?'checked':''?>  id="vaucher"/>
          <label>Do You Have Vaucher Coupon </label>
