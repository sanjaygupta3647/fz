...
$client->setRedirectUri('http://fizzkart.com/Google-login'); // paste the redirect URI where you given in APi Console. You will get the Access Token here during login success
...
if(isset($authUrl)) {
	...
	echo "<a class='logout' href='Google-login?logout'>Logout</a>";
}
