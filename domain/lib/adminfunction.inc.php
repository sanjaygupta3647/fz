...
class ADMIN_DAL {  
	...
	public function error() {
		if($_SESSION['sessmsg']){
			return '<div class="alertMessage error SE" id="cls"><div class="text"><strong>'.$_SESSION['sessmsg'].'</strong></div><div class="close"><a href="javascript:void(0);" onclick="javascript:closemsg(\'cls\');"><img src="'.SITE_PATH_ADM.'images/close-btn.png" alt="Close" title="Close" width="10" height="9" border="0" /></a></div></div>';	
		}
	}
	
	public function warning() {
		if($_SESSION['sessmsg']){
			return '<div class="tool-tip" id="cls"><div class="text"><strong>'.$_SESSION['sessmsg'].'</strong></div><div class="close"><a href="javascript:void(0);" onclick="javascript:closemsg(\'cls\');"><img src="'.SITE_PATH_ADM.'images/close-btn.png" alt="Close" title="Close" width="10" height="9" border="0" /></a></div></div>';	
		}	
	}
	
	public function success() {
		if($_SESSION['sessmsg']){
			return '<div class="alertMessage success SE" id="cls"><div class="text"><strong>'.$_SESSION['sessmsg'].'</strong></div><div class="close"><a href="javascript:void(0);" onclick="javascript:closemsg(\'cls\');"><img src="'.SITE_PATH_ADM.'images/close-btn.png" alt="Close" title="Close" width="10" height="9" border="0" /></a></div></div>';	
		}	
	}
	...
	public function action($vars, $ids, $tags=''){
		return '<a href="'.$vars.'&id='.$ids.'"><img src="<?=SITE_PATH_MEM?>images/edit.png" width="20" height="20" alt="Edit record" title="Edit record"/></a>&nbsp;&nbsp;<a href="'.SITE_PATH_ADM.(($tags)?$tags:CPAGE).'?id='.$ids.'&action=del&view=true" onclick="return confirm(\'Do you want delete this record?\');"><img src="<?=SITE_PATH_MEM?>images/delete_icon.png" width="20" height="20" alt="Delete record" title="Delete record"/></a>';
	}
