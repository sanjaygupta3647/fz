<div id="container2"> <span class="text_a_c2"><?=$cms->getSingleresult("select name from #_category where pid = '".$items[3]."'")?> </span>
    <div class="container2_data"><?php 
	 $store=$cms->db_query("select pid,title,clicks,image1,price,offerprice from #_products_user where store_user_id='$current_store_user_id' and status = 'Active' and cat_id = '".$items[3]."' order by pid desc");
  ...
  <div id="container3"> <span class="text_a">Most Visited</span>
    <div class="container2_data"><?php
	 $mostvisited=$cms->db_query("select pid,title,clicks,image1,price,offerprice from #_products_user where store_user_id='$current_store_user_id' and status = 'Active' and cat_id = '".$items[3]."' order by clicks desc limit 0, 10");
